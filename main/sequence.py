...
from main.core import LocalActivationUnit
from main.normalization import LayerNormalization

if tf.__version__ >= '2.0.0':
    from main.rnn_v2 import dynamic_rnn
else:
    from main.rnn import dynamic_rnn
from main.rnn_utils import QAAttGRUCell, VecAttGRUCell
