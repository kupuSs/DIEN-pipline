...
from main.inputs import build_input_features, get_varlen_pooling_list, create_embedding_matrix, embedding_lookup, \
    varlen_embedding_lookup, SparseFeat, DenseFeat, VarLenSparseFeat, get_dense_input, combined_dnn_input
from main.core import DNN, PredictionLayer
from main.sequence import AttentionSequencePoolingLayer, DynamicGRU
from main.utils import concat_fun, reduce_mean
...
def DIEN(dnn_feature_columns, history_feature_list, embedding_size=8, hist_len_max=16,
         ...
         l2_reg_dnn=0, l2_reg_embedding=1e-6, dnn_dropout=0, init_std=0.0001, seed=2019, task='binary'):
    ...
    query_emb_list = embedding_lookup(embedding_dict, features, sparse_feature_columns,
                                      return_feat_list=history_feature_list,
                                      )  # query是单独的
